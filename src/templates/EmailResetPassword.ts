type EmailResetPasswordParams = {
  email: string;
  code: number
}

export const EmailResetPassword = ({email, code}: EmailResetPasswordParams) => {
    const html = `
                        ...
                        <tbody>
                          <tr>
                            <td style="padding: 0 0 24px 0; font-size: 18px; line-height: 150%; font-weight: bold; color: #000000; letter-spacing: 0.01em;">
                              Olá, por acaso esqueceu sua senha?
                            </td>
                          </tr>
                          <tr>
              ...
              Este é o seu codigo: ${code}
                          ...
                          <tr>
                            <td style="font-size: 14px; line-height: 170%; font-weight: 400; color: #000000; letter-spacing: 0.01em;">
                              Atenciosamente, <br><strong>TransNex</strong>
                            </td>
                          </tr>
                        </tbody>
                      </table>
                  ...
                  <tr>
                    <td style="padding: 24px 0 48px; font-size: 0px;">
                      ...
                      <div class="outlook-group-fix" style="padding: 0 0 20px 0; vertical-align: top; display: inline-block; text-align: center; width:100%;">
                        <span style="padding: 0; font-size: 11px; line-height: 15px; font-weight: normal; color: #8B949F;">TransNex<br/>Ainda a Definir</span>
                      </div>
